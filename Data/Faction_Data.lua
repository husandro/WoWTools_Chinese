...
[2764]= {"寻猎者的旅程", "艾泽拉斯四面受敌之际，阿斯塔洛·血誓发现了一种保卫银月城的特殊方式。"},
...
[2699]= {"奇点特勤", "深入虚影风暴执行任务的虚空精灵"},
[2698]= {"至暗之夜"},

[2696]= {"阿曼尼部族", "阿曼尼是巨魔诞生后最先成立的部族之一。千年之间，他们征服并掌控了东部王国的绝大部分土地……直到远走他乡的精灵出现在这里。"},
...
[2372]= {"搏击竞技场（第4赛季）", "一群格斗狂人从各地收罗来了各种生物，将它们放置在血腥的竞技场中与部落的英雄们进行生死搏斗。"},
[2371]= {"比兹莫搏击俱乐部（第4赛季）", "一群格斗狂人从各地收罗来了各种生物，将它们放置在血腥的竞技场中与联盟的英雄们进行生死搏斗。"},
[2370]= {"恐龙训练 - 恐角龙"},
...
[2063]= {nil, "这座人类势力的最后堡垒目前由流浪归来的国王瓦里安·乌瑞恩统治着。"},
