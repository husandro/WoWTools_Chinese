...
local tab={
    ...
    [170]= {"残暴强韧", "首领的生命值提高25%，首领及其爪牙造成的伤害最多提高15%。非首领敌人的生命值提高20%，造成的伤害最多提高20%。"},
[169]= {"伊特努丝的试炼：暮光倒影", "在战斗中时，伊特努丝会召唤邪恶的你。"},
[168]= {"伊特努丝的试炼：时间流具现", "在战斗中时，伊特努丝会召唤一个分裂多次的元素。"},
[167]= {"伊特努丝的试炼：永恒黄昏", "在战斗中时，伊特努丝会召唤永恒龙军团伏击玩家。"},
[166]= {"伊特努丝的试炼：时间之沙", "在战斗中时，伊特努丝会显化能够接住的青铜法球。"},
[165]= {"林多尔米的指引", "林多尔米指引玩家，利用时光之沙削弱特定的非首领敌人，且玩家死亡不会扣除剩余时间。"},
...
[158]= {"萨拉塔斯的交易：虚缚", "战斗中，萨拉塔斯会召唤虚缚大使。虚缚大使会强化附近的敌人。"},
...
[7]= {"激励", "任何非首领敌人死亡时，其临死的哀嚎将强化附近的盟友，使其生命值暂时提高10%。"},
