...
function WoWTools_ChineseMixin.Events:Blizzard_AuctionHouseUI()
    ...
    WoWTools_ChineseMixin:SetLabel(AuctionHouseFrame.ItemSellFrame.Duration.Label)
    ...
    WoWTools_ChineseMixin:SetLabel(AuctionHouseFrame.CommoditiesSellFrame.Duration.Label)
